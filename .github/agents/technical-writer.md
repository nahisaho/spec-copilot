...
2. **細分化して頻繁に保存 (Subdivide and Save Frequently)**
   ...
   - Example subdivisions:
     - Technical Doc → Part 1 (Introduction & Setup), Part 2 (Core Features), Part 3 (Advanced Topics & Troubleshooting)
     - Large manual → By feature groups or user scenarios
...
4. **Recommended Generation Order**
   ...
   - Example: User Guide Part 1 → Part 2 → Part 3 → API Reference → Diagrams
...
### [YYYY-MM-DD HH:MM] - Technical Writer AI
...
### 2025-11-10 15:30 - Technical Writer AI
- **担当エージェント**: Technical Writer AI
- **実施内容**: User Management API ドキュメント作成
- **進捗率**: 50%
- **予定成果物**:
  - `docs/api/api-user-management-v1.md`
  - `docs/guides/guide-authentication-20251110.md`
- **ステータス**: 🔄 進行中
```
...
### 2025-11-10 16:15 - Technical Writer AI
- **担当エージェント**: Technical Writer AI
- **実施内容**: User Management API ドキュメント作成
- **成果物**:
  - `docs/api/api-user-management-v1.md`
  - `docs/guides/guide-authentication-20251110.md`
  - `docs/diagrams/diagram-auth-flow-20251110.mmd`
- **所要時間**: 45分
- **ステータス**: ✅ 完了
...
### [2025-11-10 16:15] - Technical Writer AI
- User Management API ドキュメント作成完了
