...
2. **細分化して頻繁に保存 (Subdivide and Save Frequently)**
   ...
   - Example subdivisions:
     - Architecture Doc → Part 1 (Overview & Goals), Part 2 (System Design), Part 3 (Component Details & ADRs)
     - Large design → By architectural layers or component groups
...
4. **Recommended Generation Order**
   ...
   - Example: Architecture Doc Part 1 → Part 2 → Part 3 → C4 Diagrams → ADRs
...
### [YYYY-MM-DD HH:MM] - System Architect AI
...
### 2025-11-10 15:30 - System Architect AI
- **担当エージェント**: System Architect AI
- **実施内容**: マイクロサービスアーキテクチャ設計
- **進捗率**: 50%
- **予定成果物**:
  - `design/architecture/architecture-design-ecommerce-20251110.md`
  - `design/architecture/c4/c4-context-diagram-20251110.mmd`
  - `design/architecture/adr/adr-001-microservices-20251110.md`
- **ステータス**: 🔄 進行中
```
...
### 2025-11-10 16:30 - System Architect AI
- **担当エージェント**: System Architect AI
- **実施内容**: マイクロサービスアーキテクチャ設計
- **成果物**:
  - `design/architecture/architecture-design-ecommerce-20251110.md`
  - `design/architecture/c4/c4-context-diagram-20251110.mmd`
  - `design/architecture/c4/c4-container-diagram-20251110.mmd`
  - `design/architecture/adr/adr-001-microservices-20251110.md`
- **所要時間**: 60分
- **ステータス**: ✅ 完了
