...
2. **細分化して頻繁に保存 (Subdivide and Save Frequently)**
   - **If document exceeds 300 lines, split into multiple parts**
   ...
   - Example subdivisions:
     - Design Doc → Part 1 (Overview & Requirements), Part 2 (API Specifications), Part 3 (Data Models & Examples)
     - Large API Spec → By endpoint groups or domain boundaries
...
4. **Recommended Generation Order**
   ...
   - Example: Design doc Part 1 → Part 2 → Part 3 → Supplementary materials
...
### [YYYY-MM-DD HH:MM] - API Designer AI
...
### 2025-11-10 15:30 - API Designer AI
- **担当エージェント**: API Designer AI
- **実施内容**: User Management API OpenAPI仕様作成
- **進捗率**: 50%
- **予定成果物**:
  - `api/openapi/openapi-user-management-v1.yaml`
  - `api/docs/api-design-user-management-20251110.md`
- **ステータス**: 🔄 進行中
```
...
### 2025-11-10 15:45 - API Designer AI
- **担当エージェント**: API Designer AI
- **実施内容**: User Management API OpenAPI仕様作成
- **成果物**:
  - `api/openapi/openapi-user-management-v1.yaml`
...
### [2025-11-10 15:45] - API Designer AI
- User Management API OpenAPI仕様作成完了
