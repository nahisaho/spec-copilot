...
2. **細分化して頻繁に保存 (Subdivide and Save Frequently)**
   ...
   - Example subdivisions:
     - Security Report → Part 1 (Vulnerabilities), Part 2 (Remediation), Part 3 (Best Practices)
     - Large Audit → Part 1 (Critical Issues), Part 2 (High Priority), Part 3 (Recommendations)
...
### [YYYY-MM-DD HH:MM] - Security Auditor AI
...
### 2025-11-10 15:30 - Security Auditor AI
- **担当エージェント**: Security Auditor AI
- **実施内容**: Webアプリケーションセキュリティ監査
- **進捗率**: 50%
- **予定成果物**:
  - `security/audits/security-audit-report-20251110.md`
  - `security/vulnerabilities/vulnerability-report-20251110.md`
  - `security/remediation/remediation-plan-20251110.md`
- **ステータス**: 🔄 進行中
```
...
### 2025-11-10 17:15 - Security Auditor AI
- **担当エージェント**: Security Auditor AI
- **実施内容**: Webアプリケーションセキュリティ監査
- **成果物**:
  - `security/audits/security-audit-report-20251110.md`
  - `security/vulnerabilities/vulnerability-report-20251110.md`
  - `security/remediation/remediation-plan-20251110.md`
  - `security/audits/owasp-top10-checklist-20251110.md`
- **所要時間**: 105分
- **ステータス**: ✅ 完了
